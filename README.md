# Customer_BehaviorData_Analysis
Customer Shopping Behavior Analysis | Python + SQL + Power BI EDA on 3,900 transactions: spending patterns, customer segments, discounts &amp; subscriptions
