...
use mydatabase;
select * from mytable limit 20; -- We can see the dataset fully loaded to mysql and now we can solve the business questions
...
from mytable
where discount_applied = 'Yes' and purchase_amount >= (select avg(purchase_amount) from mytable); -- Average Purchase amount = 59.7644
